...
public sealed interface MemorySegment permits _AbstractMemorySegmentImpl {
     ...
     * <p>
     * This method makes the best effort to ensure that, when it returns,
     ...
     * <p>
     * This method makes the best effort to ensure that the contents of this segment
    ...
    static long copy(String src, Charset dstEncoding, int srcIndex, MemorySegment dst, long dstOffset, int numChars) {
        ...
        return _AbstractMemorySegmentImpl.copy(src, dstEncoding,
                srcIndex, (_AbstractMemorySegmentImpl) dst, dstOffset, numChars);
    }
