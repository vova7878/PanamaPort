...
public class MethodTypeHacks {
    ...
    public static final int ARG_TO_SLOT_TABLE_OFFSET = fieldOffset(getHiddenInstanceField(INVOKE_FORM, "argToSlotTable"));
    public static final int SLOT_TO_ARG_TABLE_OFFSET = fieldOffset(getHiddenInstanceField(INVOKE_FORM, "slotToArgTable"));
    public static final int ARG_COUNTS_OFFSET = fieldOffset(getHiddenInstanceField(INVOKE_FORM, "argCounts"));
    public static final int PRIM_COUNTS_OFFSET = fieldOffset(getHiddenInstanceField(INVOKE_FORM, "primCounts"));
    public static final int ERASED_TYPE_OFFSET = fieldOffset(getHiddenInstanceField(INVOKE_FORM, "erasedType"));
    public static final int BASIC_TYPE_OFFSET = fieldOffset(getHiddenInstanceField(INVOKE_FORM, "basicType"));
    ...
    public static final int FORM_OFFSET = fieldOffset(getHiddenInstanceField(MethodType.class, "form"));
