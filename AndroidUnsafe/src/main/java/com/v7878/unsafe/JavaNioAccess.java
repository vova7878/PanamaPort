...
// SegmentByteBuffer should not appear in JavaNioAccess as it breaks class loading sequence
class BufferFactory {
...
public class JavaNioAccess {
    ...
    static {
        ...
        mem_def.getClassData().getDirectMethods().add(new EncodedMethod(
                ...
                Modifier.PUBLIC | /*TODO: CONSTRUCTOR*/ 0x10000).withCode(CORRECT_SDK_INT == 26 ? 0 : 1, b -> b
                .if_(CORRECT_SDK_INT == 26,
                        unused -> b.invoke(DIRECT, MethodId.constructor(nio_mem_ref_id, TypeId.J),
                                b.this_(), b.p(0), b.p(1)),
                        unused -> b.const_4(b.l(0), 0)
                                .invoke(DIRECT, MethodId.constructor(nio_mem_ref_id, TypeId.J, TypeId.of(Object.class)),
