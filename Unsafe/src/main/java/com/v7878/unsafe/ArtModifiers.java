...
public class ArtModifiers {
    ...
    public static final int kAccSkipAccessChecks = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12, A11, A10, A9, A8p1, A8p0 ->
                0x00080000;
    ...
    public static final int kAccCopied = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12 -> 0x01000000;
    ...
    public static final int kAccCompileDontBother = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12, A11, A10, A9, A8p1 -> 0x02000000;
    ...
    public static final int kAccPreCompiled = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12 -> 0x00800000;
        case A11 -> 0x00200000;
    ...
    public static final int kAccFastInterpreterToInterpreterInvoke = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A9, A8p1, A8p0 -> 0;
    ...
    public static final int kAccPublicApi = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12, A11, A10 -> 0x10000000;
        case A9, A8p1, A8p0 -> 0;
        default -> throw unsupportedART(ART_INDEX);
    };
    ...
    public static final int kAccCorePlatformApi = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12, A11, A10 -> 0x20000000;
        case A9, A8p1, A8p0 -> 0;
        default -> throw unsupportedART(ART_INDEX);
    };
    ...
    public static final int kAccHiddenapiBits = switch (ART_INDEX) {
        case A17p2, A17p1, A17, A16p1, A16, A15, A14, A13, A12, A11, A10, A9 -> 0x30000000;
        case A8p1, A8p0 -> 0;
        default -> throw unsupportedART(ART_INDEX);
    };
