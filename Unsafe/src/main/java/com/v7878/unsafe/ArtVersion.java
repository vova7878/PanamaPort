...
public class ArtVersion {
    ...
    public static final int A17p2 = 14;
    ...
    private static boolean is37p2() {
        return checkClass("javax.crypto.KEM");
    }

    private static boolean is37p1() {
        return checkClass("jdk.internal.math.ToDecimal");
    }

    private static boolean is37() {
        return checkClass("java.lang.foreign.MemoryLayout");
    }

    private static boolean is36p1() {
        return checkClass("java.util.stream.Gatherer");
    }

    private static boolean is36() {
        return checkClass("java.lang.invoke.DirectMethodHandle");
    }
    ...
    private static int computeIndex() {
        // At the moment, there is nothing above 37 qpr 2
        final int MAX = 3700002;
        ...
        if (tmp >= 3700002 || is37p2()) return A17p2;
        if (tmp == 3700001 || is37p1()) return A17p1;
        if (tmp == 3700000 || is37()) return A17;
        if (tmp >= 3600001 || is36p1()) return A16p1;
